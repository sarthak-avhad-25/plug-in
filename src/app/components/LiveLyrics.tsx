        ...
        {lyrics.map((line, i) => {
          ...
          return (
            <div 
              ...
              className="cursor-pointer transition-all duration-[800ms] ease-[cubic-bezier(0.22,1,0.36,1)] motion-reduce:transition-none flex flex-wrap items-center justify-start origin-left text-2xl md:text-4xl tracking-tight leading-tight"
              style={{
            ...
            >
              ...
              {line.words ? line.words.map((w, wIdx) => {
                ...
                <span 
                  className={`inline-block transition-all duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] motion-reduce:transition-none ${isActive ? 'font-bold' : 'font-medium'}`}
                  style={{ 
