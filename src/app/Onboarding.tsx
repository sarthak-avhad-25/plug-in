    ...
    <div className="fixed inset-0 bg-[#020005] z-[9999] flex flex-col items-center justify-center overflow-hidden">
      ...
      <AnimatePresence mode="wait">
        ...
        {step === "create_profile" && (
          ...
          >
            <div className="bg-white/5 backdrop-blur-2xl border border-white/10 rounded-[2.5rem] p-8 md:p-12 shadow-[0_30px_60px_rgba(0,0,0,0.5)]">
              <div className="text-center mb-8">
                <h2 className="text-4xl font-black text-white mb-2">Create your profile</h2>
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-6" autoComplete="off">
                <div className="flex justify-center mb-4 w-full overflow-hidden">
                  <div className="grid grid-cols-5 gap-4 md:gap-5 max-h-60 overflow-y-auto custom-scrollbar pr-2 py-2 w-full justify-items-center">
                    {AVATARS.map(avatar => (
                      <button
                        key={avatar.id}
                        type="button"
                ...
                <div>
                  <label className="block text-white/50 text-sm font-medium mb-2 pl-2">USERNAME</label>
                  <input
                    type="text"
                    required
                    ...
                    className="w-full bg-black/50 border border-white/10 rounded-[1.5rem] px-8 py-6 text-2xl text-white font-black placeholder:text-white/20 focus:outline-none focus:border-[#D4FF00] transition-colors text-center shadow-inner"
                    autoComplete="off"
                  />
                </div>
                ...
                <button
                  ...
                  className="w-full bg-[#D4FF00] text-black font-black text-2xl tracking-wide rounded-[1.5rem] py-6 mt-6 hover:scale-[1.02] active:scale-95 transition-all flex items-center justify-center shadow-[0_0_30px_rgba(212,255,0,0.3)] disabled:opacity-50 disabled:hover:scale-100 disabled:shadow-none"
                >
                  Enter PlugIn
                </button>
              </form>
